...
from Acquire.Service import set_trusted_service_info, create_return_value
from Acquire.Service import login_to_service_account, get_service_info
from Acquire.Service import get_service_private_key, Service, \
                            MissingServiceAccountError
from Acquire.Service import remove_trusted_service_info, \
